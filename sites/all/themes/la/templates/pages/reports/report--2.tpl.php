            ...
            <div class="card-body">
              <?php print render($date_form); ?>
                ...
                <table class="table table-bordered table-hover" id="table-daily" data-time="<?php print $date; ?>">
                    ...
                    <tr data-browse="106" class="color-interactive">
                    ...
                    <tr data-browse="107" class="color-interactive">
                    ...
                    <tr data-browse="104" class="color-interactive">
                    ...
                    <tr data-browse="105" class="color-interactive">
