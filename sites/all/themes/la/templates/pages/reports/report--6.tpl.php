            ...
            <div class="card-body">
              <?php print render($date_form); ?>
                ...
                <table class="table table-bordered table-hover" id="table-daily" data-time="<?php print $date; ?>">
                    ...
                    <tr data-browse="216" class="color-interactive">
                    ...
                    <tr data-browse="217" class="color-interactive">
                    ...
                    <tr data-browse="214" class="color-interactive">
                    ...
                    <tr data-browse="215" class="color-interactive">
