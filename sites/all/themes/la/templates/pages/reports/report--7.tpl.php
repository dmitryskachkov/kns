                                ...
                                <div class="media-body">
                                  <?php print render($date_form); ?>
                                    ...
                                    <table class="table table-bordered table-hover" id="table-daily" data-time="<?php print $date; ?>">
                                        ...
                                        <tr data-browse="316"  data-find="0" class="color-interactive">
                                        ...
                                        <tr data-browse="317"  data-find="0" class="color-interactive">
                                        ...
                                        <tr data-browse="314" data-find="0" class="color-interactive">
                                        ...
                                        <tr data-browse="315"  data-find="0" class="color-interactive">
