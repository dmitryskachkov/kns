 ...
 */
function la_process_page(&$variables) {
 ...
 */
function la_preprocess_block(&$variables) {
 ...
 */
function la_menu_tree($variables) {
 ...
 */
function la_field__taxonomy_term_reference($variables) {
  $output = '';
...
function la_theme() {
  ...
  $items['user_register_form'] = array(
    ...
    'preprocess functions' => array(
      'la_preprocess_user_register_form'
    ),
  );
  $items['user_pass'] = array(
    ...
    'template' => 'user-pass',
    'preprocess functions' => array(
      'la_preprocess_user_pass'
    ),
  );
  return $items;
}
function la_preprocess_user_login(&$vars) {
  $vars['intro_text'] = t('This is my awesome login form');
}

function la_preprocess_user_register_form(&$vars) {
  $vars['intro_text'] = t('This is my super awesome reg form');
}

function la_preprocess_user_pass(&$vars) {
  $vars['intro_text'] = t('This is my super awesome request new password form');
}

function la_menu_tree__main_menu(&$variables) {
    return '<ul class="nav page-navigation">' . $variables['tree'] . '</ul>';
}


function la_menu_link(array $variables) {
