              ...
              <?php if ($unit) : ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>Router VPN Public IP: <span class="float-right">192.168.22.54</span></p>
                                ...
                                <div class="media-body">
                                  <?php print render($date_form); ?>
                                    ...
                                    <table class="table table-bordered table-hover" id="table-daily" data-time="<?php print $date; ?>">
                                        ...
                                        <tbody>
                                        <tr data-browse="409" class="color-interactive">
                                        ...
                                        <tr data-browse="410" class="color-interactive">
                                        ...
                                        <tr data-browse="411" class="color-interactive">
                                        ...
                                        <tr data-browse="416"  data-find="0" class="color-interactive">
                                        ...
                                        <tr data-browse="417"  data-find="0" class="color-interactive">
                                        ...
                                        <tr data-browse="412" class="color-interactive">
                                        ...
                                        <tr data-browse="414" data-find="0" class="color-interactive">
                                        ...
                                        <tr data-browse="413" class="color-interactive">
                                        ...
                                        <tr style="border-top: 3px solid #333333" data-browse="403" class="color-interactive">
                                        ...
                                        <tr data-browse="404" class="color-interactive">
